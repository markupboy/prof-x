...
version: 1.0.0
description: |
  Refine a development ticket — or brainstorm a raw idea — into a validated,
  self-contained REQUIREMENTS document — the "what", verified against the
  codebase. Use when asked to "refine this ticket", "grill the requirements",
  "turn this into REQUIREMENTS", or "/refine-ticket".
allowed-tools:
  - Read
  - Write
  - Edit
