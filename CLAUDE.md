...
├── implement/        # /implement skill (Linear ticket → plan → implement → validate → optionally ship)
...
├── pr-review-interactive/ # /pr-review-interactive skill (browser triage of a review) + server.py, index.html, app.js, renderer.js, styles.css
